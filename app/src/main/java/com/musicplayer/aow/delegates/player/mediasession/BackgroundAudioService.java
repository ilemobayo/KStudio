...
public class BackgroundAudioService extends MediaBrowserServiceCompat implements MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener  {
    ...
    private MediaSessionCompat.Callback mMediaSessionCallback = new MediaSessionCompat.Callback() {
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            try {
                ...
                try {
                    mMediaPlayer.setDataSource(mPlaylist.get(Integer.valueOf(mediaId)).getPath());
    ...
    private void initSongs(){
        Cursor data = new CursorDB().songs(this);
        if (data != null) {
            while (data.moveToNext()) {
                mPlaylist.add(new CursorDB().cursorToMusic(data));
            }
            data.close();
        }
    }
