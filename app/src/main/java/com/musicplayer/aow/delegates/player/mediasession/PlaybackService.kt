...
import com.musicplayer.aow.delegates.player.MyContentObserver
...
//        return super.onStartCommand(intent, flags, startId)
    ...
    constructor(parcel: Parcel) : this() {
        mPlaybackAttributes = parcel.readParcelable(AudioAttributes::class.java.classLoader)
        mFocusRequest = parcel.readInt()
    }
