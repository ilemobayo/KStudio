...
public class PlayList implements Parcelable {
    ...
    public static final String PLAYING_INDEX = "playing";
    public static final String NUMBER_OF_SONGS = "sizeofsongs";
    ...
    public void readFromParcel(Parcel in) {
        ...
        this.songs = in.createTypedArrayList(Song.Companion.getCREATOR());
    ...
    public SongResolver nextWithIndex() {
        switch (playMode) {
            case LOOP:
            case LIST:
            case SINGLE:
        ...
        return new SongResolver(songs.get(playingIndex),playingIndex);
    }
