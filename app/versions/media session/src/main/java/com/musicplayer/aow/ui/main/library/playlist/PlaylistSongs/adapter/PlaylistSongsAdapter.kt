package com.musicplayer.aow.ui.main.library.playlist.PlaylistSongs.adapter
 ...
 */
class PlaylistSongsAdapter(context: Context, song: PlayList, activity: Activity): RecyclerView.Adapter<PlaylistSongsAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder?, position: Int) {
        ...
        var songDuration = TimeUtils.formatDuration(model.duration)
