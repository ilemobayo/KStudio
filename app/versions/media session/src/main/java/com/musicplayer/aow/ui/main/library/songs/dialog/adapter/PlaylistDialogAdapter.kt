 ...
 */
class PlaylistDialogAdapter (context: Context, playlist: List<PlayList>, song: Song, dialog: BottomSheetDialog): RecyclerView.Adapter<PlaylistDialogAdapter.PlayListViewHolder>() {
